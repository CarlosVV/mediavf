...
namespace AutoTrade.Core.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to A stock data provider with the name {0} was not found..
        /// </summary>
        internal static string StockDataProviderNotFoundMessage {
            get {
                return ResourceManager.GetString("StockDataProviderNotFoundMessage", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to A stock data provider of type {0} was not found..
        /// </summary>
        internal static string StockDataProviderTypeNotRegisteredMessage {
            get {
                return ResourceManager.GetString("StockDataProviderTypeNotRegisteredMessage", resourceCulture);
            }
        }
