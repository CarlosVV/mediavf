...
using MediaVF.Services.Properties;

namespace MediaVF.Services
{
    ...
    public class ServiceBootstrapper : Bootstrapper
    {
        ...
        public override void Run(bool runWithDefaultConfiguration)
        {
            ...
            try
            {
                ...
                componentManager.ServiceComponents.ForEach(component => component.InitializeComponent());

                // run components
                componentManager.RunComponents();
            }
            catch (Exception ex)
            {
